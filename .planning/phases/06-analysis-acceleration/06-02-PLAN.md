...
must_haves:
  truths:
    ...
    - "Analysis time is reduced by 50%+ compared to sequential"
...
<objective>
Implement parallel API call processing with rate limiting to achieve 50-70% reduction in analysis time by processing multiple batches concurrently.
...
6. Analysis completes 50%+ faster than sequential (measured in summary)
</success_criteria>
