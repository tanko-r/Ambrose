...
3. Progress endpoint returns human-readable time estimate
4. Frontend polls progress every second during analysis
5. Progress bar updates visually with percentage
6. Risks appear in sidebar as batches complete (not all at once at end)
7. Skip stats are visible in progress details
</verification>
