- generic:
  - generic:
    ...
    - generic:
      ...
      - main:
        - generic:
          - generic:
            - generic:
              - button
              - button: PURCHASE AND SALE AGREEMENT
              - button
              - button:
              ...
              - button: 5.4.1 Seller shall have delivered those items described in Section 11.3hereof as provided in this Agreement;
              - button: 5.4.2 Title Company shall be irrevocably committed to issue the Title Policy pursuant to Section 4 hereof; and
              - button: 5.4.3 Each representation and warranty made by Seller in this Agreement shall be true, accurate and complete in all material respects as of the Closing Date.
              - button: 5.4.4 [Seller shall have delivered the Minimum Tenant Estoppels, each substantially in the form of Exhibit H attached hereto.]
              - button: "5.5 Seller's Conditions Precedent. In addition to all other conditions to Seller's obligations in this Agreement, Seller and Buyer agree that Seller's obligation to proceed with the Closing is subject to the satisfaction or waiver by Seller of the following conditions at or prior to the Closing:"
              - button: 5.5.1 Buyer shall have deposited the Closing Payment into escrow;
              - button: 5.5.2 Buyer shall have delivered those items described in Section 11.4 hereof as provided in this Agreement; and
              - button: 5.5.3 Each representation and warranty made by Buyer in this Agreement shall be true, accurate and complete in all material respects of as of the Closing Date.
              - button: 5.6 Waiver of Conditions Precedent. The conditions set forth in Sections 5.1 through 5.4are for the exclusive benefit of Buyer and the conditions set forth in Section 5.5 are for the exclusive benefit of Seller. If any of the conditions set forth in this Section 5 have not been satisfied or waived within the period provided, this Agreement may be terminated by the party benefiting from such condition by written notice to the other party.
              - button: "6 Termination of Agreement. If this Agreement is terminated for any reason other than as described in Section 13: (a) all documents deposited with the Escrow Holder by Buyer shall be returned to Buyer, all documents deposited with Escrow Holder by Seller shall be returned to Seller, and all documents delivered to Buyer by Seller shall be returned to Seller; (b) no Broker's Fee shall be payable to Broker; and (c) the parties shall equally share any cancellation fee of the Escrow Holder."
              - button: 7 Representations and Warranties.
              - button: "7.1 Seller's Representations and Warranties. Seller represents and warrants to Buyer as follows:"
              - button: 7.1.1 Seller is a ___________ duly organized and validly existing under the laws of the State of ___________. This Agreement and all documents executed by Seller that are to be delivered to Buyer at the Closing are, or at the time of Closing will be, duly authorized, executed and delivered by Seller, and are, or at the time of Closing will, be legal, valid and binding obligations of Seller, and do not, and at the time of Closing, will not, violate any provisions of any contract or judicial order to which Seller is a party or to which Seller is subject.
              - button: 7.1.2 To Seller's Actual Knowledge, the rent roll identified in the Due Diligence Documents (the “Rent Roll”) is true and correct in all material respects.
              - button: 7.1.3 To Seller's Actual Knowledge, as of the Effective Date, Seller has received no notice from any governmental authority with jurisdiction over the Property of any current violation by the Property of any laws, ordinances or regulations applicable to the Property, and Seller is in compliance with any such past notices of past violations. Seller shall immediately provide Buyer with a copy of any such notices received after the Effective Date.
              - button: 7.1.4 To Seller's Actual Knowledge, there is no litigation pending or threatened against Seller.
              - button: 7.1.5 To Seller's Actual Knowledge, no condemnation or eminent domain proceedings are pending or threatened against the Property.
              - button: 7.1.6 [To the best of Seller’s knowledge, except as set forth on Exhibit H hereto, no tenant under any lease in existence as of the Effective Date is entitled to any concession or allowance (including free or reduced rent) except as previously paid or credited to Buyer, no rent has been paid more than thirty (30) days in advance and Seller is not obligated to make or pay for improvements to any tenant space. To the best of Seller’s knowledge, no leasing commissions or similar fees are due to any person in connection with the current term of any lease in existence as of the Effective Date except as previously paid by Seller or credited to Buyer at Closing. Seller has not received any written notice of default on the part of the landlord under any lease nor, to Seller’s knowledge, does there exist any material default or breach on the part of the landlord or the tenant under any lease. To the best of Seller’s knowledge, the copies of the leases delivered to or made available to Buyer were true, correct and complete in all material respects.]
              - button:
              ...
              - button: 100 Main Street, Suite 200
              - button: Anytown, WA 98101
              - button:
                - generic: "Attn:"
                - text: Jane Attorney
              - button:
              ...
              - button
              - button
              - button: EXECUTED by Seller on _________________, 20___.
              - button
              - button:
                - generic: SELLER
                - text: ":"
              ...
              - button
              - button: EXHIBIT A
              - button: (Real Property Legal Description)
              - button
              - button:
              ...
              - table:
                - rowgroup:
                  ...
                  - row:
                    - cell:
                      - button: "Legal Description:"
                      - button
                      - button: "Abbreviated Legal Description:"
                      - button
                      - button: "Full Legal Description: See Exhibit A attached."
                      - button
                  - row:
                    - cell:
                      - button: "Assessor's Tax Parcel Nos.:"
                  - row:
                    - cell:
                      - button: "Reference Nos. of Documents Released or Assigned:"
              - button
              - button: SPECIAL WARRANTY DEED
              - button:
              ...
              - button
              - button
              - button: Signature must be acknowledged
              - button: Attach Legal Description
              - button: Attach Permitted Exceptions
              - text: EXHIBIT C
              - button
              - button: Bill of Sale
              - button
              ...
              - button
              - button
              - button: "[Personal Property of Personal Property Included in the Sale]"
              - button
              - text: EXHIBIT D
              - button
              - button: Assignment and Assumption of Leases
              - button
              - button:
              ...
              - button
              - button: "ACCORDINGLY, the parties hereto agree as follows:"
              - button
              - button:
              ...
              - button: Assignment and Assumption of Leases
              - button
              - button: (List of Leases – Rent Roll)
              - button
              - text: EXHIBIT E
              - button
              - button: Assignment and Assumption of Contracts and Intangibles
              - button
              - button:
              ...
              - text: SCHEDULE I
              - button: to
              - button: Assignment and Assumption of Contracts and Intangible Property
              - button
              - button: (List of Contracts)
              - button
              - text: EXHIBIT G
              - button
              - button: Certificate of Rent Roll
              - button
              - button
              - button:
                - text: "To:"
      ...
      - complementary:
        ...
        - tabpanel:
          - generic:
            - img
            - paragraph: No risks identified for this clause. It looks good!
        - generic:
          - generic:
    ...
    - generic:
      - generic:
        - generic:
          - generic: 1 — Purchase and Sale. Seller agrees to sell and convey to Buye...
        - generic:
          - button:
            - img
          - button:
  ...
  - generic [ref=e104] [cursor=pointer]:
    ...
    - generic [ref=e1416]:
      ...
      - button "Collapse issues badge" [ref=e1423]:
        - img [ref=e1424]
  - alert
  - dialog "Settings" [ref=e4720]:
    - generic [ref=e4721]:
      - heading "Settings" [level=2] [ref=e4722]
      - paragraph [ref=e4723]: Customize your workspace appearance and behavior.
    - generic [ref=e4724]:
      - generic [ref=e4725]:
        - text: Theme
        - generic [ref=e4726]:
          - button "Light" [active] [ref=e4727]:
            - img
            - text: Light
          - button "Dark" [ref=e4728]:
            - img
            - text: Dark
          - button "System" [ref=e4729]:
            - img
            - text: System
      - generic [ref=e4730]:
        - generic [ref=e4731]:
          - text: Compact Mode
          - paragraph [ref=e4732]: Reduce spacing between cards and panels
        - switch [checked] [ref=e4733]
      - generic [ref=e4734]:
        - text: Default Sidebar Tab
        - paragraph [ref=e4735]: Tab shown when selecting a paragraph
        - combobox [ref=e4736]:
          - generic: Risks
          - img
      - generic [ref=e4737]:
        - generic [ref=e4738]:
          ...
          - paragraph [ref=e4739]: Show document navigator by default on session load
        - switch [checked] [ref=e4740]
    - button "Close" [ref=e4741]:
      - img
      - generic [ref=e4742]: Close