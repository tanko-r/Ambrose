- generic:
  ...
  - button "Open Next.js Dev Tools" [ref=e81] [cursor=pointer]:
    - img [ref=e82]
  - alert
  - dialog "Finalize & Export" [ref=e2174]:
    - generic [ref=e2175]:
    ...
    - heading "1F Expanded the definition to explicitly include (i) licenses and concessions to ca..." [level=3] [ref=e2198]:
      - button "1F Expanded the definition to explicitly include (i) licenses and concessions to ca..." [active] [ref=e2199]:
        - generic [ref=e2200]:
    ...
    - generic [ref=e2206]:
      - button "Cancel" [ref=e2207]
      - button "Export" [ref=e2208]:
        - text: Export
        - img
