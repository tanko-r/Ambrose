- generic:
  ...
  - button "Open Next.js Dev Tools" [ref=e81] [cursor=pointer]:
    - img [ref=e82]
  - alert
  - dialog "Finalize & Export" [ref=e2129]:
    - generic [ref=e2130]:
      - heading "Finalize & Export" [level=2] [ref=e2131]
      - paragraph [ref=e2132]: Review your approved revisions and export Word documents.
    - generic [ref=e2133]:
      - generic [ref=e2134]:
        - img [ref=e2135]
        - generic [ref=e2138]: "1"
        - generic [ref=e2139]: revisions approved
      - generic [ref=e2140]:
        - img [ref=e2141]
        - generic [ref=e2143]: "2"
        - generic [ref=e2144]: items flagged
      - generic [ref=e2145]:
        - img [ref=e2146]
        - generic [ref=e2148]: "141"
        - generic [ref=e2149]: risks not yet reviewed
    - generic [ref=e2152]:
      - heading "1F Expanded the definition to explicitly include (i) licenses and concessions to ca..." [level=3] [ref=e2153]:
        - button "1F Expanded the definition to explicitly include (i) licenses and concessions to ca..." [expanded] [ref=e2154]:
          - generic [ref=e2155]:
            - generic [ref=e2156]: 1F
            - generic [ref=e2157]: Expanded the definition to explicitly include (i) licenses and concessions to ca...
          - img
      - region "1F Expanded the definition to explicitly include (i) licenses and concessions to ca..." [ref=e2166]:
        - generic [ref=e2168]:
          - text: Leases. All right, title and interest of Seller in and to all leases
          - insertion [ref=e2171]: ", subleases, licenses, concessions"
          - text: and other agreements to occupy the Real Property and/or the Improvements, or any portion thereof
          - insertion [ref=e2172]: ", together with all amendments, modifications, supplements, renewals and extensions thereof, and all guaranties, security deposits, letters of credit, prepaid rents and other credit support held in connection therewith"
          - text: (collectively, the “Leases”).
    - generic [ref=e2158]:
      - text: Track Changes Author
      - textbox "Track Changes Author" [active] [ref=e2159]:
        - /placeholder: e.g., David Smith
        - text: Test Attorney
      - paragraph [ref=e2160]: This name appears as the revision author in Word.
    - generic [ref=e2161]:
      - button "Cancel" [ref=e2162]
      - button "Export" [ref=e2163]:
        - text: Export
        - img
    - button "Close" [ref=e2164]:
      - img
      - generic [ref=e2165]: Close