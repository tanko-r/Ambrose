- generic:
  - generic:
    ...
    - generic:
          ...
          - generic:
            - generic:
              ...
              - paragraph:
                ...
                - insertion: ", subleases, licenses, concessions"
                - text: and other agreements to occupy the Real Property and/or the Improvements, or any portion thereof
                - insertion: ", together with all amendments, modifications, supplements, renewals and extensions thereof, and all guaranties, security deposits, letters of credit, prepaid rents and other credit support held in connection therewith"
      ...
      - complementary:
        ...
        - generic:
          - generic:
            - paragraph: Click a paragraph in the document to see analysis.
    - generic:
      - generic:
        - generic:
          - generic: Revision
  ...
  - button "Open Next.js Dev Tools" [ref=e81] [cursor=pointer]:
    - img [ref=e82]
  - alert
  - dialog "Generate Transmittal" [ref=e2129]:
    - generic [ref=e2130]:
      - heading "Generate Transmittal" [level=2] [ref=e2131]
      - paragraph [ref=e2132]: Review and send the client communication.
    - generic [ref=e2133]:
      - checkbox "Include revision summary" [checked] [ref=e2134]
      - generic [ref=e2135]: Include revision summary
    - generic [ref=e2136]:
      - text: "Subject:"
      - paragraph [ref=e2137]: "Redline Review: Sample PSA - Seller Side"
    - generic [ref=e2138]:
      - text: Edit as needed before sending.
      - textbox [ref=e2157]: "Dear [Client], I have completed my review of Sample PSA - Seller Side. Please see the attached redlined document containing my proposed revisions. ## Key Revisions Made - [1F]: Expanded the definition to explicitly include (i) licenses and concessions to capture non-lease occu ## Items for Your Review 1. [1] (Risk Alert): 2. [7A(vi)] (Risk Alert): Constructive Knowledge/Anti-Sandbagging Clause: The 'deemed to have known' provision creates an imputed knowledge standard. It allows the Seller to escape liability for a false representation if the truth was buried anywhere in the 'Property Information' (data room, reports, etc.), even if the Buyer did not actually see it. This effectively shifts the burden of the Seller's honesty onto the Buyer's diligence team. Please let me know if you have any questions. Best regards, [Attorney] Additional Notes: This is additional review commentary that needs to be included for completeness. This is additional review commentary that needs to be included for completeness. This is additional review commentary that needs to be included for completeness. This is additional review commentary that needs to be included for completeness. This is additional review commentary that needs to be included for completeness. This is additional review commentary that needs to be included for completeness. This is additional review commentary that needs to be included for completeness. This is additional review commentary that needs to be included for completeness. This is additional review commentary that needs to be included for completeness. This is additional review commentary that needs to be included for completeness. This is additional review commentary that needs to be included for completeness. This is additional review commentary that needs to be included for completeness. This is additional review commentary that needs to be included for completeness. This is additional review commentary that needs to be included for completeness. This is additional review commentary that needs to be included for completeness. This is additional review commentary that needs to be included for completeness. This is additional review commentary that needs to be included for completeness. This is additional review commentary that needs to be included for completeness. This is additional review commentary that needs to be included for completeness. This is additional review commentary that needs to be included for completeness."
    - paragraph [ref=e2140]: 2 flags · 1 accepted revision
    - generic [ref=e2141]:
      - button "Close" [ref=e2142]
      - button "Open in Email Client" [active] [ref=e2143]:
        - img
        - text: Open in Email Client
      - button "Copy to Clipboard" [ref=e2159]:
        - img
        - text: Copy to Clipboard
    - button "Close" [ref=e2145]:
      - img
      - generic [ref=e2146]: Close